  ...
  try {
    ...
    while ((dirent = dir.readSync()) !== null) {
      ...
      if (dirName.length >= 10) {
        ...
        // Only store the display name in groupedAircraft entries.
        // The grouped modules will use the shared `simObjectsDir` when emitted.
    ...
    // Use the shared simObjectsDir as the sourceDir for grouped modules
    // (this intentionally points the module at the full Airplanes tree)
    ...
    // This was added to create the draft 1.6 release... where all Liveries are one large module
    //
    ...
    // Log to console the aircraft objects for verification the sourceDirs are correct
